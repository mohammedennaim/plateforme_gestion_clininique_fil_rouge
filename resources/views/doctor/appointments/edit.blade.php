            ...
            <div class="p-8">
                <form action="{{ route('doctor.appointments.update', $appointment->id) }}" method="POST">
                    ...
                    <div class="mt-8 bg-gray-50 p-6 rounded-xl shadow-sm">
                        ...
                        <div class="mb-4 space-y-1">
                            <label for="reason" class="block text-sm font-medium text-gray-700">Motif de la consultation</label>
                        ...
                        <div class="mb-4 space-y-1">
                            ...
                            <textarea id="notes" name="notes" rows="4" 
                                class="w-full px-4 py-2 form-textarea">{{ $appointment->notes ?? '' }}</textarea>
                        </div>
                    </div>
